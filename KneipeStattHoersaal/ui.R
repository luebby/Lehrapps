...
shinyUI(
  navbarPage(title = "Stichprobenumfang des Dreieckstest",
             tabPanel("Hintergrund",
                      fluidPage(titlePanel("FOMshiny: Stichprobenumfang"),
                                fluidRow(column(
                                  12,
                                  h3("Hintergrund"),
                                  p(
                                    "Das Signifikanzniveau alpha einer Hypothesenprüfung sagt, wie oft Sie maximal die Nullhypothese verwerfen wollen, obwohl sie gilt.",
                                  ...
                                  p(
                                    "Im Beispiel Kneipe statt Hörsaal, führte eine Stichprobe von $n = 34$ einen Dreieckstest durch.",
