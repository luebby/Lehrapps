...
tabPanel("Hintergrund", 
         fluidPage(
           ...
           fluidRow(column(12, "Für e können Sie verschiedene Standardabweichungen einstellen und so schauen welche Anteile der Variation von y modelliert werden können.")),
         ...
         fluidPage(
           sidebarLayout(
             sidebarPanel(
               ...
               fluidRow(column(12,"Probieren Sie verschiedene Fehlervariationen aus.")),
