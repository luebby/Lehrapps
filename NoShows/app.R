  ...
  tabPanel("Daten zusammenfassen",
           ...
           sidebarLayout(
             sidebarPanel(
               ...
               h4("Eingabe:"),
               sliderInput("k0", "Kennzahl:", min = 0, max = 8, value = si, step = 0.5, ticks = FALSE),
               br(),
  ...
  tabPanel("1. Szenario",
           sidebarLayout(
             sidebarPanel(
               ...
               h4("Eingabe:"),
               sliderInput("k1", "Ihre Vorhersage:", min = 0, max = 8, value = si, step = 0.5, ticks = FALSE),
               h4("Ergebnis:"),
               textOutput("t1"),
               br(),
               h4("Hinweis:"),
  ...
  tabPanel("2. Szenario",
           sidebarLayout(
             sidebarPanel(
               ...
               p("Welche Zahl sollten Sie jetzt wählen? Bei welcher Zahl ist Ihr erwarteter Lohn maximal?"),
               h4("Eingabe:"),
               sliderInput("k2", "Ihre Vorhersage:", min = 0, max = 8, value = si, step = 0.5, ticks = FALSE),
               h4("Ergebnis:"),
               textOutput("t2"),
               br(),
               h4("Hinweis:"),
  ...
  tabPanel("3. Szenario",
           sidebarLayout(
             sidebarPanel(
               ...
               p("Welche Zahl sollten Sie jetzt wählen? Bei welcher Zahl ist Ihr erwarteter Lohn maximal?"),
               h4("Eingabe:"),
               sliderInput("k3", "Ihre Vorhersage:", min = 0, max = 8, value = si, step = 0.5, ticks = FALSE),
               h4("Ergebnis:"),
               textOutput("t3"),
               br(),
               h4("Hinweis:"),
